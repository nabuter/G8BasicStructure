...
private: // channel access
  ...
  // EventChannelReadToken<Type>
  //, EventChannelWriteToken<Type>
  // access tokens for all the channels you read and write
  // example
  StreamChannelReadToken<PrimaryControls>  PrimaryControlsReadToken;
  StreamChannelWriteToken<ControlSignal> ControlSignalWriteToken;
  StreamChannelReadToken<FeedbackStream>  FeedbackReadToken;
